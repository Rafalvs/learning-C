/*
Validador de Cpf, codigo meio bagunçado que eu pretendo arrumar algum dia, da pra usar argc e argv, mas funciona sem ele.

CPF validator (CPF is a brazilian document, could be translated something like: Natural Persons Register. its based in an algorithm to validate 11-digits)
code is kinda messy, but running. Runnable with argc argv, that i tested.
*/
